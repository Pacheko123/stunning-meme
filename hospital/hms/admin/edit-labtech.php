...
$sql=mysqli_query($con,"Update lab set lab_name='$name',username='$username', password='$password'");
if($sql)
{
$msg="Lab Technician Details updated Successfully";
...
<html lang="en">
	<head>
		<title>Admin | Edit Lab Tech Details</title>
