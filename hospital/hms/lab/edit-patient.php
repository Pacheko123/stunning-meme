...
$patage=$_POST['patage'];
$medhis=$_POST['medhis'];
$sql=mysqli_query($con,"insert into labresult(results,pat_id) VALUES('$medhis','$eid')") or die(mysqli_error($con));
if($sql)
{
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Patient | Add Test</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Patient</span>
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Enter Patient Test Results(comma separated)" required="true"></textarea>
</div>	
